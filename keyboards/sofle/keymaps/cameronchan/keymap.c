...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_PGUP, LSFT(KC_INS), LGUI_T(KC_Q), LALT_T(KC_W), LSFT_T(KC_E), LCTL_T(KC_R), KC_T, KC_Y, RCTL_T(KC_U), RSFT_T(KC_I), RALT_T(KC_O), RGUI_T(KC_P), KC_PGDN, KC_GRV, LGUI_T(KC_A), LALT_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F), KC_G, KC_H, KC_J, KC_K, KC_L, RGUI_T(KC_SCLN), KC_QUOT, KC_ESC, LGUI_T(KC_Z), LALT_T(KC_X), LSFT_T(KC_C), LCTL_T(KC_V), KC_B, KC_MUTE, KC_NO, KC_N, RCTL_T(KC_M), RSFT_T(KC_COMM), RALT_T(KC_DOT), RGUI_T(KC_SLSH), KC_ESC, KC_ESC, TO(3), MO(1), KC_TAB, KC_SPC, KC_ENT, KC_BSPC, KC_DEL, TO(2), KC_ESC),
